...
import { selectCartItems, selectCartState, selectCartTotalAmount, selectCartTotalQty, setCloseCart, setGetTotal } from "../app/CartSlice.js"
...
const Cart = () => {
    ...
    const totalAmt = useSelector(selectCartTotalAmount);
    ...
    const cartCompo = cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
        ...
        <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
            <div className="flex items-center justify-between">
                ...
                <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">{totalAmt}</h1>
            </div>
